  ...
  var t = {
      ...
      7675: function (t, e, n) {
        ...
        t.exports = function (t, e, n, l, h, x, S) {
          ...
          if (
            ...
            if (((A = {values: j(g), keys: x ? U : j(y), entries: j(b)}), S))
              for (P in A) (v || E || !(P in L)) && c(L, P, A[P]);
            else r({target: e, proto: !0, forced: v || E}, A);
          return A;
        };
      },
      7400: function (t, e, n) {
      ...
      4121: function (t, e, n) {
        ...
        var r,
          ...
          Pt = function (t) {
            var e,
              ...
              a = S(r, {type: 'URL'});
            if (void 0 !== o)
              if (o instanceof Pt) e = O(o);
              else if ((n = At((e = {}), String(o)))) throw TypeError(n);
            if ((n = At(a, u, null, e))) throw TypeError(n);
        ...
        if (
          (i &&
            s(jt, {
              ...
              port: Mt(It, function (t) {
                var e = O(this);
                V(e) ||
                  ('' == (t = String(t)) ? (e.port = null) : At(e, t, vt));
              }),
          ...
          Nt &&
            c(Pt, 'createObjectURL', function (t) {
              return Nt.apply(b, arguments);
            }),
            Dt &&
              c(Pt, 'revokeObjectURL', function (t) {
                return Dt.apply(b, arguments);
              });
        }
        m(Pt, 'URL'), o({global: !0, forced: !u, sham: !i}, {URL: Pt});
      },
    },
    e = {};
  function n(r) {
